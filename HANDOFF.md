# HANDOFF.md — Claude Code ⇄ Claude Chat handoff log

This file is the handoff log between Claude Code (executor) and Claude Chat (coordinator). Claude Code prepends a summary after each task. Claude Chat reads the latest entry instead of the user pasting it. Newest entry is always at the top.
